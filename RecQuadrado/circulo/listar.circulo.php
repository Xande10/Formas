        ...
        <fieldset>
            ...
            <h3>Pesquisar por:</h3>
                ...
                <div class="form-check form-check-inline">
                    ...
                    <label class="form-check-label" for="inlineRadio2">Raio</label>
                </div>
                <div class="form-check form-check-inline">
            ...
            <table class="table table-success table-striped">
                <thead class="table-dark">
                    <tr>
                        ...
                        <th scope="col"> Mostrar Circulo </th>
                ...
                <?php
                    ...
                    <tr>
                        ...
                        <td scope="row"><?php echo $linha['raio'];?></td>
                        <td scope="row"><?php echo $linha['cor'];?></td>
                        <td scope="row"><?php echo $linha['idtabuleiro'];?></td>
                        <td scope="row"><a href="mostrar.circulo.php?raio=<?php echo $linha["raio"];?>&cor=<?php echo str_replace('#', '%23', $linha['cor']);?>&idtabuleiro=<?php echo $linha["idtabuleiro"];?>"><img src="../img/square.svg" alt=""></a></td>
                        <td scope="row"><?php echo "<a href=javascript:excluirRegistro('../acao/circulo.acao.php?acao=excluir&id={$linha['id']}')>"; ?><img src="../img/trash.svg" alt=""></a></td>
                        <td scope="row"><a href="formulario.circulo.php?acao=editar&id=<?php echo $linha['id'];?>"><img src="../img/editar.svg" alt=""></a></td>
                    </tr>
                <?php } ?> 
                </tbody>
            </table>
