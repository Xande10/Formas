...
<?php
    ...
    include_once "../acao/retangulo.acao.php";
    include_once "../classes/autoload.php";

    $title = "Tabela Retângulo";
        ...
        <fieldset>
            ...
            <h3>Pesquisar por:</h3>
                ...
                <div class="form-check form-check-inline">
                    ...
                    <label class="form-check-label" for="inlineRadio2">Altura</label>
                </div>
                <div class="form-check form-check-inline">
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="buscar" id="inlineRadio3" value="3" <?php if ($buscar == "4") echo "checked" ?>>
            ...
            <table class="table table-success table-striped">
                <thead class="table-dark">
                    <tr>
                        ...
                        <th scope="col"> Mostrar Retângulo </th>
                ...
                <?php
                    ...
                    <tr>
                        ...
                        <td scope="row"><?php echo $linha['altura'];?></td>
                        <td scope="row"><?php echo $linha['base'];?></td>
                        <td scope="row"><?php echo $linha['cor'];?></td>
                        <td scope="row"><?php echo $linha['idtabuleiro'];?></td>
                        <td scope="row"><a href="mostrar.retangulo.php?altura=<?php echo $linha["altura"];?>&base=<?php echo $linha["base"];?>&cor=<?php echo str_replace('#', '%23', $linha['cor']);?>&idtabuleiro=<?php echo $linha["idtabuleiro"];?>"><img src="../img/square.svg" alt=""></a></td>
                        <td scope="row"><?php echo "<a href=javascript:excluirRegistro('../acao/retangulo.acao.php?acao=excluir&id={$linha['id']}')>"; ?><img src="../img/trash.svg" alt=""></a></td>
                        <td scope="row"><a href="formulario.retangulo.php?acao=editar&id=<?php echo $linha['id'];?>"><img src="../img/editar.svg" alt=""></a></td>
                    </tr>
                <?php } ?> 
                </tbody>
            </table>
