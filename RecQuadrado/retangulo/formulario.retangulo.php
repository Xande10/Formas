<?php
    ...
    if(isset($_GET['id'])) {
        $id = $_GET['id'];
        $ret = new Retangulo('','','','','');
        $lista = $ret->listar(1, $id);
    }

    $title = "Cadastro de Retangulo";
...
<html lang="en">
    ...
    <body style="background-color:darkcyan">
        ...
        <fieldset> 
            <br>
            <center><h1>Cadastro de um Retangulo</h1></center>
            <br>
            <form action="../acao/retangulo.acao.php" method="post" class="row row-cols-lg-auto g-3 align-items-center">
                <div class="mx-auto">
                    <div class="col-12">
                        <input readonly type="hidden" name="id" id="id" value="<?php if (isset($id)) echo $lista[0]['id'];?>">    
                        <div class="input-group">
                            <div class="input-group-text border border-dark border border-2">Altura:</div>
                            <input class="form-control border border-dark border border-2" type="text" name="altura" id="altura" placeholder="Insira o altura" value="<?php if (isset($id)) echo $lista[0]['altura'];?>">
                        </div>
                    </div>
                    <br>
                    <div class="col-12">
                        <div class="input-group">
                            <div class="input-group-text border border-dark border border-2">Base:</div>
                            <input class="form-control border border-dark border border-2" type="text" name="base" id="base" placeholder="Insira o base" value="<?php if (isset($id)) echo $lista[0]['base'];?>">
                        </div>
                    </div>
                    <br>
                    <div class="col-12">
